...
Design and code an application assigned to you
...
- You can use any of the things covered in the classes from Week 1 to Week 4
- You can use any of the events and inbuild JS functions for arrays, string and objects
